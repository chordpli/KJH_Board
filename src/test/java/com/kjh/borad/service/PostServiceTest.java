...
class PostServiceTest {
	...
	public void setUp() {
		...
		post2 = new Post(2L, "Title2", "안녕하세요. 글로벌 날리지 게시판 과제 제출합니다. 김준호입니다.", LocalDateTime.now());
		post3 = new Post(3L, "Title3", "안녕하세요. 글로벌 날리지 지원자 김준호입니다. 인사", LocalDateTime.now());
		post4 = new Post(4L, "Title4", "안녕하세요. 글로벌 날리지 개발자 과제 제출합니다.", LocalDateTime.now());
		post5 = new Post(5L, "Title5", "안녕하세요. 글로벌 날리지 과제 제출 완료했습니다. 잘 부탁드립니다.", LocalDateTime.now());
		post6 = new Post(6L, "Title6", "안녕하세요. 글로벌 날리지 과제 제출합니다.", LocalDateTime.now());
		post7 = new Post(7L, "Title7", "안녕하세요. 사람인 글로벌 날리지 과제 제출합니다.", LocalDateTime.now());
		post8 = new Post(8L, "Title8", "안녕하세요. 게시판 과제 제출합니다.", LocalDateTime.now());
		post9 = new Post(9L, "Title9", "안녕하세요. 글로벌 날리지 첫번째 게시판 과페 입니다.", LocalDateTime.now());
		post10 = new Post(10L, "Title10", "안녕하세요. 좋은 아침입니다. 잘 부탁드립니다.", LocalDateTime.now());
		post11 = new Post(11L, "Title11", "글로벌 날리지 여러분 점심은 잘 드셨나요? 행복한 하루 되세요", LocalDateTime.now());
		...
		post16 = new Post(16L, "Title16", "안녕하세요. 글로벌 날리지 오늘 교육과 과제 내용은 다음과 같습니다. 다들 집중해주세요.", LocalDateTime.now());
		post17 = new Post(17L, "Title17", "글로벌 날리지 내일 교육 및 과제 내용은 다음과 같이 진행됩니다. 과제 내용 숙지 한 번 더 잘 부탁드립니다. 다들 잘 아시겠죠?",
			LocalDateTime.now());
		post18 = new Post(18L, "Title18", "글로벌 날리지 여러분 식사 맛있게 하셨나요? 남은 시간도 힘내주세요!", LocalDateTime.now());
	...
	public void testCalculateExcludedWords() {
		assertEquals(Set.of("글로벌", "과제", "안녕하세요", "날리지"), excludedWords);
	}
